...
def main():
    ...
    train_set = DatasetFromHdf5("/content/drive/My Drive/cs231n/project/Test_Project/data/srresnet_x4_gray.h5")
    ...
    optimizer = optim.Adam(model.parameters(), weight_decay = 1e-3, lr=opt.lr)
...
def save_checkpoint(model, epoch):
    model_out_path = "/content/drive/My Drive/cs231n/project/Test_Project/checkpoint/" + "model_epoch_{}.pth".format(epoch)
    state = {"epoch": epoch ,"model": model}
    if not os.path.exists("/content/drive/My Drive/cs231n/project/Test_Project/checkpoint/"):
        os.makedirs("/content/drive/My Drive/cs231n/project/Test_Project/checkpoint/")
